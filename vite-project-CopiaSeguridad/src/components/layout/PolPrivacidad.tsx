...
const lista1 = [
    {
      ...
      contenido: 'Recopilamos la información que proporcionas voluntariamente al registrarte en EcoConnect, como tu nombre, dirección de correo electrónico, fecha de nacimiento, género, ubicación y otros detalles de perfil.'
    },
    {
      icono: 'looks_two',
      titulo: 'Información de uso',
      contenido: 'Recopilamos información sobre cómo interactúas con nuestra plataforma, incluidos tus patrones de navegación, actividades de inicio de sesión, interacciones con otras cuentas y publicaciones, y cualquier información que compartas en EcoConnect.'
    },
    {
      icono: 'looks_3',
      titulo: 'Información de dispositivo',
      contenido: 'Recopilamos información sobre el dispositivo que utilizas para acceder a EcoConnect, como tu dirección IP, tipo de dispositivo, sistema operativo, identificadores únicos del dispositivo y datos de ubicación aproximada.'
    }
  ];
...
const lista4 = [
    {
      ...
      contenido: 'Utilizamos tu información para proporcionar, mantener, personalizar y mejorar la funcionalidad y el rendimiento de EcoConnect, así como para desarrollar nuevos productos y servicios.'
    },
    {
      icono: 'looks_two',
    ...
    },
    {
      ...
      contenido: "Podemos utilizar tu información para mostrarte anuncios personalizados, promociones y contenido relevante relacionado con EcoConnect, tanto en nuestra plataforma como en sitios web de terceros."
    }
  ];
        ...
        <div className="container">
            <div className="row">
                <div className="col s10 offset-s1 m8 offset-m2 l10 offset-l1 ">
                    <h3 className="header center blue-grey-text text-darken-2 letraShadow2">Política de Privacidad de EcoConnect</h3>
                    ...
                    <p className="blue-grey-text text-darken-4 div-class">
                        Bienvenido a EcoConnect, la red social del futuro comprometida con la conciencia medioambiental. 
                        En EcoConnect, nos comprometemos a proteger y respetar tu privacidad. 
                        Esta Política de Privacidad describe cómo recopilamos, usamos y protegemos la información personal que puedas proporcionarnos a través de nuestra plataforma EcoConnect.
                    </p>
                    ...
                    Sin embargo, podemos compartir tu información con proveedores de servicios de confianza que nos ayudan a proporcionar y mantener EcoConnect, así como con autoridades legales en respuesta a solicitudes legales válidas.
                    </p>
                    ...
                    no dudes en ponerte en contacto con nosotros a través de info@ecoconnect.com.
                    </p>
                    ...
                    <p className="left light blue-grey-text text-darken-2">Tu equipo de EcoConnect</p>
                </div>
            </div>
        </div>
    )
